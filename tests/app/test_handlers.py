...
from src.app.dependencies import get_get_html, get_get_binary
...
def test_parse(read_from_test_data: ReadFromTestDataFunc, clothing_with_color: Clothing) -> None:
    app.dependency_overrides[get_get_html] = lambda: AsyncMock(
        return_value=HTML(html=read_from_test_data("lamoda.html"))
    )
    app.dependency_overrides[get_get_binary] = lambda: AsyncMock(
